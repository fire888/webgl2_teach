...
import { m4 } from '../../helpers2/m4'
import { webglLessonsUI } from '../../helpers/webgl-lessons-ui'

import img01 from '../../assets/img01.jpg'
import vs from './s.vert'
import fs from './ss.frag'
...
function main() {
    ...
    const texInfo = loadImageAndCreateTextureInfo(img01, render);
    ...
    webglLessonsUI.setupUI(document.querySelector("#ui"), data, [
        ...
        { type: "checkbox", key: "triangles",  change: update },
    ]);
